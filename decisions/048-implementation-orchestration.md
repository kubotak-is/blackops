...
1. `orchestration/STATE.md`、現在のTask Packet、Report、Working Treeを確認する
...
各Task終了時、Block発生時、Sessionを終了する前に、Orchestrator Codexまたは実装担当Codexが `orchestration/STATE.md` を更新する。再開時は、最初に `AGENTS.md`、`orchestration/STATE.md`、現在のTask Packet、Reportを読み、状態を再構築する。
