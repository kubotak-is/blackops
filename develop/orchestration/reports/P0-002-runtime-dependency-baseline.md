...
- `docs/internal/runtime-dependencies.md` (new): 各DependencyのConstraint、Lock Version、PHP Requirement、採用理由と用途を記録。
- `docs/internal/README.md` (edit): `Runtime Dependencies` へのLinkをPlanned Topicsへ追加。
- `develop/STATE.md` (edit): Task StatusをIn Progressへ更新、Timestamp更新。
- `develop/orchestration/reports/P0-002-runtime-dependency-baseline.md` (new): 本Report。
...
- [x] PHPUnitが成功する
- [x] Deptracが成功する
- [x] 各Dependencyの採用理由と用途が内部向け文書へ記録される（`docs/internal/runtime-dependencies.md`）
