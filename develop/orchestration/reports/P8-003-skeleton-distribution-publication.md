...
User承認後、GitHub Runner UID／GIDをComposeへ渡すPermission Fixと、既存bare SemVer Tagを明示CheckoutするManual Recovery PathをWorkflowへ追加する。修正版をMainから`1.0.0`へ実行し、Distribution `main`とTagを確認する。生成後の`blackops/skeleton`をPackagistへ登録し、P8-004 Remote Create-project Smokeへ進む。
