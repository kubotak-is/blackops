...
- `develop/decisions/007-supervision-policy.md`
- `develop/decisions/030-lifecycle-event-data.md`
...
- `develop/spec/03-execution.md`
- `develop/TODO.md`
- `develop/orchestration/tasks/P4-002-supervision-policy-contract.md`
- `develop/orchestration/reports/P4-002-supervision-policy-contract.md`
- `develop/STATE.md`
...
`develop/orchestration/reports/P4-002-supervision-policy-contract.md` に次を記録する。
