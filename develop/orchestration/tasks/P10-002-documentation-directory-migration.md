...
- [x] `docs/internal/`に全Internal Documentationが存在する
- [x] `docs/internals/`が存在しない
- [x] AGENTSとRoot READMEの現行Pathが`docs/internal/`を指す
- [x] 有効なMarkdown LinkとTaskの変更可能Pathが新Directoryへ同期する
- [x] Acceptance Evidence中心のInstalled Application Statusが公開GuideからInternalへ移る
- [x] Guide／Internal IndexがAudience境界と一致する
- [x] 許可したRename履歴以外に旧Path参照が残らない
...
! rg -n 'docs/internals|\.\./internals' AGENTS.md README.md docs/guide docs/internal develop --glob '*.md' --glob '!develop/decisions/063-developer-experience-roadmap.md' --glob '!develop/decisions/081-documentation-website-delivery-contract.md' --glob '!develop/spec/41-developer-experience-roadmap.md' --glob '!develop/spec/57-documentation-website-delivery-contract.md' --glob '!develop/spec/58-phase-10-delivery-plan.md' --glob '!develop/orchestration/tasks/P10-001-documentation-website-contract.md' --glob '!develop/orchestration/reports/P10-001-documentation-website-contract.md' --glob '!develop/orchestration/tasks/P10-002-documentation-directory-migration.md' --glob '!develop/orchestration/reports/P10-002-documentation-directory-migration.md'
