...
- [ ] Website Unit／Check／Buildが成功する
- [ ] PHP Composer／Mago／PHPUnit／Deptracが成功する
- [ ] GitHub Actions CIとDocumentation Deploy Workflowが成功する
- [ ] PreviewとProductionの主要URLが期待Status／Contentを返す
- [ ] Internal／Develop／CredentialがArtifactへ含まれない
- [ ] README、Guide、Internal Setup、TODO、Phase Planが実装と一致する
