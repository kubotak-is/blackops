...
- `develop/orchestration/tasks/P2-009-phase-2-closeout.md`
- `develop/orchestration/reports/P2-009-phase-2-closeout.md`
- `develop/STATE.md`
...
`develop/orchestration/reports/P2-009-phase-2-closeout.md` に次を記録する。
