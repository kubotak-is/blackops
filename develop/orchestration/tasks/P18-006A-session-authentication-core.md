...
- `develop/spec/47-dependency-injection-boundary.md`
...
- Authentication用のLookup／TouchはHTTP Adapterが利用するInternal Portとし、Token HashやStored SessionをPublic APIへ出さない。
...
- Public `BearerSessionAuthenticator` と `CookieSessionAuthenticator` は別Classとし、どちらも既存`HttpAuthenticator`を実装する。
...
- `develop/spec/17-core-api.md`、`develop/spec/44-public-application-bootstrap-api.md`、`develop/spec/47-dependency-injection-boundary.md`、`develop/spec/74-application-ergonomics.md`、`develop/spec/75-phase-18-delivery-plan.md`
