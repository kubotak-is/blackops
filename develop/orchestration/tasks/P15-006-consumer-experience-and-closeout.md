...
- GuideのFrontend Journey、BlackOps CLI、Configuration、Security、Troubleshooting、Directory Structure、Current Status同期
...
- `frontend:generate`／`frontend:check`／`config/frontend.php`とExit ContractをBlackOps CLI／Configuration Referenceへ追加する
