...
Latest Stable `1.0.0`はPhase 8時点であり、`main`にあるProject CLI、Typed Self-handled Operation改善、Validation、Worker Mode Default、Documentation改善はまだStable Releaseへ含まれていない。
