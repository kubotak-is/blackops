...
既存`docs/guide/installed-application-status.md`のようなAcceptance Evidence中心の文書は`docs/internal/`へ移す。`mvp-status.md`は利用者に影響する実装済み機能と既知制約へ整理し、Contributor向け証拠は公開本文から除く。
