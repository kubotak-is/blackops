...
Transactional Outboxは、業務MutationとDeferred child Operationを同じNamed ConnectionのTransactionへ参加させるPersistence Adapterを提供する。Relayは有限Batch、Lease／Heartbeat、Fencing、Retry／Backoff、Dead Letter再開を備え、配送保証はat-least-onceである。
