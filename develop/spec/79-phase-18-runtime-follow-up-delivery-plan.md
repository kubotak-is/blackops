...
- [ ] Default Classic／Worker EntrypointがVendor Runtime Classを直接Importしない
- [ ] Worker Failure後にEnvironment／Execution／Connection境界が復元される
- [ ] Public UUIDv7 GeneratorをApplication InfrastructureへConstructor Injectionできる
- [ ] Auth Generator／Community Board DomainがSymfony UID／BlackOpsへ直接依存しない
- [ ] Quickstart／Skeleton／Community Boardから未使用Direct Dependencyを削除できる
- [ ] DBAL／Migrations Direct DependencyとVendor API対応が維持される
