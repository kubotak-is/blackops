...
- [x] Framework／Skeleton `1.1.0` TagとPackagist Metadataが一致する
- [x] 公開Packageから通常／`--no-scripts` Create-projectとQuickstartが成功する
- [x] GitHub Release `1.1.0`が確定Release Noteを持つ
