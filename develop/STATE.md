...
Updated At: 2026-07-17T11:22:44+09:00
...
Task ID: P12-004B-actor-propagation-and-authorization-runtime (Task Packet作成待ち)
...
`#[Authorize]`、Policy／Request／Decision、Manifest後方互換、Compiled Container Policy登録、Build両経路を受け入れた。Orchestrator独立確認でも対象PHPUnit 86 tests／204 assertions、Mago format／lint／analyze、Deptrac、Management ID Guard、Diff Checkが成功した。
...
1. P12-004B Actor Propagation and Authorization RuntimeのTask Packetを作成する。
