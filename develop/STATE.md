...
Updated At: 2026-07-17T12:17:46+09:00
...
Task ID: P12-005B-deferred-worker-reauthorization-and-system-actor (Task Packet作成待ち)
...
Canonical Actor ID／Type保存、PostgreSQL Codec、旧Payload互換、Observed／JSONL Actor ID Maskを受け入れた。Orchestrator独立確認でも対象41 tests／213 assertions、Deprecation 0、Mago、Deptrac、各Guardが成功した。
...
1. P12-005B Deferred Worker Reauthorization and System ActorのTask Packetを作成する。
