...
- `orchestration/reports/P1-001-core-contracts-and-identifiers.md`
...
`orchestration/reports/P1-001-core-contracts-and-identifiers.md` に次を記録する。
