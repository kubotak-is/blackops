...
- `tests/Internal/**`
- `docs/internals/**`
- `orchestration/tasks/P1-030-build-artifacts-command.md`
- `orchestration/reports/P1-030-build-artifacts-command.md`
...
`orchestration/reports/P1-030-build-artifacts-command.md` に次を記録する。
