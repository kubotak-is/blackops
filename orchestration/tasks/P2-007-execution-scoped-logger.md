...
- `mago.toml`
- `deptrac.yaml`
- `orchestration/tasks/P2-007-execution-scoped-logger.md`
- `orchestration/reports/P2-007-execution-scoped-logger.md`
...
`orchestration/reports/P2-007-execution-scoped-logger.md` に次を記録する。
