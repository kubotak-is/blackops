...
- `decisions/064-installed-application-layout-and-bootstrap.md`
- `spec/17-core-api.md`
- `spec/42-installed-application-boundary.md`
- `spec/43-installed-application-layout-and-bootstrap.md`
- `spec/44-public-application-bootstrap-api.md`
...
- `orchestration/tasks/P7-002-public-application-bootstrap-foundation.md`
- `orchestration/reports/P7-002-public-application-bootstrap-foundation.md`
...
- [ ] Reportと`orchestration/STATE.md`が更新される
...
`orchestration/reports/P7-002-public-application-bootstrap-foundation.md` に次を記録する。
