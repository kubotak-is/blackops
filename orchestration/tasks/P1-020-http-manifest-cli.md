...
- `mago.toml`
- `deptrac.yaml`
- `orchestration/tasks/P1-020-http-manifest-cli.md`
- `orchestration/reports/P1-020-http-manifest-cli.md`
...
`orchestration/reports/P1-020-http-manifest-cli.md` に次を記録する。
