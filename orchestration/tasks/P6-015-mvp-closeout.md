...
- `TODO.md` の実装済み／名称変更済み／MVP後の分類整理
- `DOCS.md` の現行仕様／Guide／Internals導線と古い仮称の注記
- Guide／Internals Indexの更新
- MVP最終品質CommandとSample E2Eの再実行
- Closeout Reportと`orchestration/STATE.md`のMVP Complete Checkpoint
...
- `spec/34-mvp-database-transport.md`
...
`orchestration/reports/P6-015-mvp-closeout.md` に次を記録する。
