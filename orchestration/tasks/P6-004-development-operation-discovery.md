...
- `decisions/011-project-structure.md`
- `decisions/012-operation-registry-and-manifest.md`
...
- `TODO.md`
- `orchestration/tasks/P6-004-development-operation-discovery.md`
- `orchestration/reports/P6-004-development-operation-discovery.md`
...
`orchestration/reports/P6-004-development-operation-discovery.md` に次を記録する。
