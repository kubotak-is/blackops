...
- `decisions/062-retention-audit-log-delivery.md`
...
- `spec/README.md`
- `decisions/062-retention-audit-log-delivery.md`
- `orchestration/tasks/P6-014-retention-audit-system-log.md`
- `orchestration/reports/P6-014-retention-audit-system-log.md`
...
`orchestration/reports/P6-014-retention-audit-system-log.md` に次を記録する。
