...
- `decisions/063-developer-experience-roadmap.md`
- `spec/07-project-structure.md`
- `spec/14-package-architecture.md`
- `spec/15-source-layout.md`
- `spec/17-core-api.md`
- `spec/40-mvp-delivery-plan.md`
- `spec/41-developer-experience-roadmap.md`
...
- `orchestration/tasks/P7-001-installed-application-composition-audit.md`
- `orchestration/reports/P7-001-installed-application-composition-audit.md`
...
`orchestration/reports/P7-001-installed-application-composition-audit.md` に次を記録する。
