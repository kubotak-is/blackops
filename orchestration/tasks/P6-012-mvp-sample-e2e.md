...
- `decisions/055-inline-dispatcher-api.md`
...
- `TODO.md`
- `orchestration/tasks/P6-012-mvp-sample-e2e.md`
- `orchestration/reports/P6-012-mvp-sample-e2e.md`
...
`orchestration/reports/P6-012-mvp-sample-e2e.md` に次を記録する。
