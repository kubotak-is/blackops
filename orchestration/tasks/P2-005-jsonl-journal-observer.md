...
- `tests/Logging/**`
- `docs/internals/**`
- `orchestration/tasks/P2-005-jsonl-journal-observer.md`
- `orchestration/reports/P2-005-jsonl-journal-observer.md`
...
`orchestration/reports/P2-005-jsonl-journal-observer.md` に次を記録する。
