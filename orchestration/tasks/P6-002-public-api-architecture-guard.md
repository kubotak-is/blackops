...
- `decisions/021-source-layout.md`
- `decisions/022-namespace-dependencies.md`
- `decisions/023-core-api-shape.md`
...
- `TODO.md`
- `orchestration/tasks/P6-002-public-api-architecture-guard.md`
- `orchestration/reports/P6-002-public-api-architecture-guard.md`
...
`orchestration/reports/P6-002-public-api-architecture-guard.md` に次を記録する。
