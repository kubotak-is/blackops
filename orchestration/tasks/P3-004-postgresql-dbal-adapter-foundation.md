...
- `tests/Http/**`
- `docs/internals/**`
- `orchestration/tasks/P3-004-postgresql-dbal-adapter-foundation.md`
- `orchestration/reports/P3-004-postgresql-dbal-adapter-foundation.md`
...
`orchestration/reports/P3-004-postgresql-dbal-adapter-foundation.md` に次を記録する。
