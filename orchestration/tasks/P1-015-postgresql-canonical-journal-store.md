...
- `deptrac.yaml`
- `mago.toml`
- `orchestration/tasks/P1-015-postgresql-canonical-journal-store.md`
- `orchestration/reports/P1-015-postgresql-canonical-journal-store.md`
...
`orchestration/reports/P1-015-postgresql-canonical-journal-store.md` に次を記録する。
