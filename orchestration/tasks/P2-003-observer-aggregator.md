...
- `docs/internals/**`
- `orchestration/tasks/P2-003-observer-aggregator.md`
- `orchestration/reports/P2-003-observer-aggregator.md`
...
`orchestration/reports/P2-003-observer-aggregator.md` に次を記録する。
