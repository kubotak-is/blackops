...
- `docs/internals/**`
- `orchestration/tasks/P1-014-lifecycle-state-machine.md`
- `orchestration/reports/P1-014-lifecycle-state-machine.md`
...
`orchestration/reports/P1-014-lifecycle-state-machine.md` に次を記録する。
