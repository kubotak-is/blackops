...
- `docs/internals/**`
- `TODO.md`
- `orchestration/tasks/P5-002-retention-hold-contract.md`
- `orchestration/reports/P5-002-retention-hold-contract.md`
...
`orchestration/reports/P5-002-retention-hold-contract.md` に次を記録する。
