...
- `TODO.md`
- `orchestration/tasks/P6-011-doctrine-versioned-migrations.md`
- `orchestration/reports/P6-011-doctrine-versioned-migrations.md`
...
`orchestration/reports/P6-011-doctrine-versioned-migrations.md` に次を記録する。
