...
- `tests/Internal/**`
- `docs/internals/**`
- `orchestration/tasks/P1-038-full-runtime-composition-wrapper.md`
- `orchestration/reports/P1-038-full-runtime-composition-wrapper.md`
...
`orchestration/reports/P1-038-full-runtime-composition-wrapper.md` に次を記録する。
