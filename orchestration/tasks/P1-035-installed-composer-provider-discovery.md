...
- `tests/Internal/**`
- `docs/internals/**`
- `orchestration/tasks/P1-035-installed-composer-provider-discovery.md`
- `orchestration/reports/P1-035-installed-composer-provider-discovery.md`
...
`orchestration/reports/P1-035-installed-composer-provider-discovery.md` に次を記録する。
