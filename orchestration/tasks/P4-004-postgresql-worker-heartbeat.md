...
- `docs/internals/**`
- `TODO.md`
- `orchestration/tasks/P4-004-postgresql-worker-heartbeat.md`
- `orchestration/reports/P4-004-postgresql-worker-heartbeat.md`
...
`orchestration/reports/P4-004-postgresql-worker-heartbeat.md` に次を記録する。
