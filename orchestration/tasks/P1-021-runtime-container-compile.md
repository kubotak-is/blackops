...
- `mago.toml`
- `deptrac.yaml`
- `orchestration/tasks/P1-021-runtime-container-compile.md`
- `orchestration/reports/P1-021-runtime-container-compile.md`
...
`orchestration/reports/P1-021-runtime-container-compile.md` に次を記録する。
