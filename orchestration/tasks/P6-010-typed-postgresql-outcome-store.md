...
- `spec/29-handler-result-contract.md`
...
- `decisions/060-typed-outcome-store-contract.md`
...
- `TODO.md`
- `decisions/060-typed-outcome-store-contract.md`
- `orchestration/tasks/P6-010-typed-postgresql-outcome-store.md`
- `orchestration/reports/P6-010-typed-postgresql-outcome-store.md`
...
`orchestration/reports/P6-010-typed-postgresql-outcome-store.md` に次を記録する。
