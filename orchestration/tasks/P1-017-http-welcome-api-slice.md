...
- `deptrac.yaml`
- `mago.toml`
- `orchestration/tasks/P1-017-http-welcome-api-slice.md`
- `orchestration/reports/P1-017-http-welcome-api-slice.md`
...
`orchestration/reports/P1-017-http-welcome-api-slice.md` に次を記録する。
