...
- `decisions/058-frankenphp-runtime-premise.md`
...
- `orchestration/tasks/P3-005-frankenphp-runtime-premise.md`
- `orchestration/reports/P3-005-frankenphp-runtime-premise.md`
...
`orchestration/reports/P3-005-frankenphp-runtime-premise.md` に次を記録する。
