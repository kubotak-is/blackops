...
- `tests/Internal/**`
- `docs/internals/**`
- `orchestration/tasks/P1-034-composer-provider-build-integration.md`
- `orchestration/reports/P1-034-composer-provider-build-integration.md`
...
`orchestration/reports/P1-034-composer-provider-build-integration.md` に次を記録する。
