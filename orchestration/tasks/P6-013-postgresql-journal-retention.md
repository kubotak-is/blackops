...
- `decisions/061-retention-operation-reference.md`
...
- `spec/38-data-retention-and-deletion.md`
- `decisions/061-retention-operation-reference.md`
- `orchestration/tasks/P6-013-postgresql-journal-retention.md`
- `orchestration/reports/P6-013-postgresql-journal-retention.md`
...
`orchestration/reports/P6-013-postgresql-journal-retention.md` に次を記録する。
