...
- `tests/Internal/**`
- `docs/internals/**`
- `orchestration/tasks/P1-028-operation-manifest-compile-command.md`
- `orchestration/reports/P1-028-operation-manifest-compile-command.md`
...
`orchestration/reports/P1-028-operation-manifest-compile-command.md` に次を記録する。
