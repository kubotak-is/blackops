...
- `docs/internals/**`
- `orchestration/tasks/P5-004-postgresql-retention-hold-store.md`
- `orchestration/reports/P5-004-postgresql-retention-hold-store.md`
...
`orchestration/reports/P5-004-postgresql-retention-hold-store.md` に次を記録する。
