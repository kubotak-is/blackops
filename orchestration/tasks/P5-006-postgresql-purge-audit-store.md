...
- `docs/internals/**`
- `orchestration/tasks/P5-006-postgresql-purge-audit-store.md`
- `orchestration/reports/P5-006-postgresql-purge-audit-store.md`
...
`orchestration/reports/P5-006-postgresql-purge-audit-store.md` に次を記録する。
