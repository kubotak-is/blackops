...
- `tests/Internal/**`
- `docs/internals/**`
- `orchestration/tasks/P2-001-sensitive-projection-foundation.md`
- `orchestration/reports/P2-001-sensitive-projection-foundation.md`
...
`orchestration/reports/P2-001-sensitive-projection-foundation.md` に次を記録する。
