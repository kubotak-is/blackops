...
- `orchestration/reports/P1-018-http-binding-and-route-manifest-foundation.md`
...
`orchestration/reports/P1-018-http-binding-and-route-manifest-foundation.md` に次を記録する。
