...
- `docs/internals/**`
- `orchestration/tasks/P1-037-command-registration-bootstrap-documentation.md`
- `orchestration/reports/P1-037-command-registration-bootstrap-documentation.md`
...
`orchestration/reports/P1-037-command-registration-bootstrap-documentation.md` に次を記録する。
