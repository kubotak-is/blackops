...
- `tests/Internal/**`
- `docs/internals/**`
- `orchestration/tasks/P1-036-production-runtime-artifact-loader.md`
- `orchestration/reports/P1-036-production-runtime-artifact-loader.md`
...
`orchestration/reports/P1-036-production-runtime-artifact-loader.md` に次を記録する。
