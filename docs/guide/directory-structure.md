...
Compile済みManifestとContainerは`var/build/`、Local Journal等は`var/log/`へ出力します。Frontendは`php blackops frontend:generate`後に`resources/js/blackops/`、TypeScript Runtime Test後に`.build/`を作ります。
