...
| Unit TestとIntegration Testが通る | Satisfied | MVP CloseoutでSample E2E、全PHPUnit、Mago、Deptrac、Composer validationを再実行する。結果はCloseout Reportと`orchestration/STATE.md`に保存する。 |
