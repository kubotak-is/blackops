...
The reference Docker image includes PCNTL. An application image running this command must also enable PCNTL; otherwise worker construction fails immediately while HTTP and build paths remain unaffected.
