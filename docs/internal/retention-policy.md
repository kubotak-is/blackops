...
PostgreSQL Purge Service Facadeは、Planner、Transport Payload Tombstone Service、Dead Letter Retention Delete Serviceを順に呼び出す。CLIとScheduler WorkerはこのFacadeを入口にする。
